...
test_ahgo -at=true -al=true -offn="src/github.com/Ken1JF/test-ahgo/Fuseki3.sgf" -ffn="src/github.com/Ken1JF/test-ahgo/Fuseki2.sgf"  -rwf=true >& test_ahgo_new.txt -fl=10 -ml=10 -ssf="src/github.com/Ken1JF/sgf/sgf_properties_spec.txt"
